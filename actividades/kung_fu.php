    ...
    <div class="contenedor_reservar_actividad">
        <div class="informacion_actividad">
            <div class="imagenes">
                ...
                <img id="imagen" src="/imagenes/actividades/kungfu_pictograma.png" />
                <img id="arrow2" src=/imagenes/next.png>
            </div>
            <div id="texto">Son muchos los valores que un arte marcial como el Kung Fu puede ofrecer a nuestros hijos. Además de ser una buena actividad física y de enseñarles a defenderse, los pequeños reforzarán algunos valores importantes, como la confianza, autodisciplina, autoestima y muchos más.</div>
        </div>
