    ...
    <div class="contenedor_reservar_actividad">
        <div class="informacion_actividad">
            <div class="imagenes">
                ...
                <img id="imagen" src="/imagenes/actividades/balonmano_pictograma.png" />
                <img id="arrow2" src=/imagenes/next.png>
            </div>
            <div id="texto">El balonmano es un deporte que trabaja las 4 extremidades del cuerpo, las piernas y los brazos del niño. La práctica de un deporte en la infancia no solo divierte como ayuda a los niños en su desarrollo físico, social e intelectual, además de colaborar para su madurez emocional. Horario: Lunes y Miércoles de 18:35 a 19:45 y precio 16 euros mensuales</div>
        </div>
