            ...
            <div class="slide">
                <div class="slide-inner">
                    ...
                    <div class="slide-item">
                        <img src="../imagenes/aulas/reserva_biblioteca_01.jpeg">
                    </div>
                    <input class="slide-open" type="radio" id="slide-2" name="slide" aria-hidden="true" hidden="">
                    <div class="slide-item">
                        <img src="../imagenes/aulas/reserva_biblioteca_02.jpeg">
                    </div>
                    <input class="slide-open" type="radio" id="slide-3" name="slide" aria-hidden="true" hidden="">
                    <div class="slide-item">
                        <img src="../imagenes/aulas/reserva_biblioteca_03.jpeg">
                    </div>
        ...
        <div class="informacion_reserva">
            ...
            <form action="" method="post">
                <div class="horario">
                    ...
                    <input type="hidden" name="id_aula" value="3">
