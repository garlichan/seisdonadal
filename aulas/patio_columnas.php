...
<body>
    ...
    <div class="contenedor_reservar_aula">
        <div class="informacion_aula">
            <h1>Patio de columnas</h1>
            <div class="slide">
                <div class="slide-inner">
                    <input class="slide-open" type="radio" id="slide-1" name="slide" aria-hidden="true" hidden="" checked="checked">
                    <div class="slide-item">
                        <img src="../imagenes/aulas/reserva_patio_columnas_01.jpeg">
                    </div>
                    <input class="slide-open" type="radio" id="slide-2" name="slide" aria-hidden="true" hidden="">
                    <div class="slide-item">
                        <img src="../imagenes/aulas/reserva_patio_columnas_02.jpeg">
                    </div>
                    <input class="slide-open" type="radio" id="slide-3" name="slide" aria-hidden="true" hidden="">
                    <div class="slide-item">
                        <img src="../imagenes/aulas/reserva_patio_columnas_03.jpeg">
                    </div>
